...
<body>
            ...
            <div class="default-select"  "="">
                ...
                <div class="nice-select" tabindex="0">
                    ...
                    <ul class="list">
                        ...
                        <?php foreach ($allCategories as $category) { ?>
                            <li data-value="<?= $category->getId() ?>" class="option"><?= $category->getName() ?></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
    ...
    <div class="container box_1170 mb-5 mr-5">
				<div class="row">
					...
					<div class="col-md-2">
                        <a href="?day=tuesday" class="genric-btn primary circle day-menu"  data-id="Tuesday">Tuesday</a>
					</div>
					<div class="col-md-2">
                        <a href="?day=wednesday" class="genric-btn primary circle day-menu" data-id="Wednesday">Wednesday</a>
					</div>
                    <div class="col-md-2">
                        <a href="?day=thursday" class="genric-btn primary circle day-menu" data-id="Thursday">Thursday</a>
					</div>
                    <div class="col-md-2">
                        <a href="?day=friday" class="genric-btn primary circle day-menu" data-id="Friday">Friday</a>
					</div>
				</div>
